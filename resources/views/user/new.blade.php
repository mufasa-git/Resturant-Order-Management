    ...
    <section class="scrollable padder">
        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                {!! Form::open(array('route'=>'user.store', 'files' => true, 'method' => 'post')) !!}
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Name</label>
                            {!! Form::text('name', '', ['placeholder'=>'Enter user name', 'class'=>'form-control input-lg','required']) !!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            {!! Form::text('email', '', ['placeholder'=>'Enter user email', 'class'=>'form-control input-lg','required']) !!}
                        </div>
                    </div>
