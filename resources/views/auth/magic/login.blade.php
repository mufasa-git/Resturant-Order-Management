...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    <div class="container aside-xxl">
        <a class="text-center block" href="index.html" style="color: #fb6b5b; font-weight: 200; font-size: 40px; margin-top: 20px;line-height: 1.0;" data-toggle="fullscreen">Akome <br><span style="font-size: 25px; color: rgb(101, 189, 119); font-weight: 900">DOMINICAN</span></a>
...
<footer id="footer">
    <div class="text-center padder">
        <p>
            <small>Copyright © {{date('Y')}} AKOME Dominican</small>
        </p>
    </div>
</footer>
<!-- / footer -->
